...
class SortListUseCase @Inject constructor(schedulerProvider: SchedulerProvider) : SingleUseCase<List<ShoppingList>, SortListUseCase.SortListParams>(schedulerProvider) {
